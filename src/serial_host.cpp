...
void _transmitData(const int txLen, const uint16_t* txDelays, const byte* txData) {
...
void _transmitDataEasy(const int txLen, const unsigned long txDelay, const byte* txData) {
    for (int i = 0; i < txLen; i++) {
        PIN_GDO0_PORT = txData[i];
