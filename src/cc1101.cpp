...
CC1101Transceiver cc1101(PIN_CLK, PIN_MISO, PIN_MOSI, PIN_CS, PIN_GDO0, PIN_GDO2);
...
void CC1101Transceiver::setup() {
  ...
  CC1101_MAIN.setPktFormat(1);       // Format of RX and TX data. 0 = Normal mode, use FIFOs for RX and TX. 1 = Synchronous serial mode, Data in on GDO0 and data out on either of the GDOx pins. 2 = Random TX mode; sends random data using PN9 generator. Used for test. Works as normal mode, setting 0 (00), in RX. 3 = Asynchronous serial mode, Data in on GDO0 and data out on either of the GDOx pins.
...
void CC1101Transceiver::select() {
  CC1101_MAIN.setModul(this->moduleNumber);
}
