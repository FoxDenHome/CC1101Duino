...
void CommandSerial::echoFirst() { this->sendFirst("<"); }
...
void CommandSerial::init() { this->serial->begin(115200); }

void CommandSerial::sendFirst() { this->serial->print('^'); }
...
void CommandSerial::sendNext(const String &text) { this->serial->print(text); }

void CommandSerial::sendEnd() { this->serial->print("\r\n"); }
